      ...
      <div className={`about-inner reveal${inView ? ' in-view' : ''}`} ref={ref}>
        ...
        <div className="about-text">
          ...
          <p className="about-bio">
            元海上自衛官（護衛艦勤務）を経て、マーケティングの世界へ。マーケティング会社のCOO・複数社のCMOとして事業成長の最前線に立ち、これまでに累計300店舗超の事業成長を支援。現在はHau'oli growth代表として、また株式会社LeameのCEOとして店舗経営にも携わりながら、言葉とマーケティングに加えて仕組みの力で、正しく報われる努力を増やし続けている。
          </p>
