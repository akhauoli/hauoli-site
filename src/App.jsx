      ...
      <div className={`about-inner reveal${inView ? ' in-view' : ''}`} ref={ref}>
        ...
        <div className="about-text">
          ...
          <p className="about-bio">
            元海上自衛官（護衛艦勤務）を経て、マーケティングの世界へ。マーケティング会社のCOO、複数社のCMOを歴任後、Hau'oli growth代表として200を超えるクライアントの事業成長を支援。株式会社LeameのCEOとしても店舗経営に携わりながら、言葉とマーケティングに加えて仕組みの力で、正しく報われる努力を増やし続けている。
          </p>
