...
// 上昇パーティクル（決定論的配置）
const PARTICLES = [
  { left:  8, delay: 0.0, dur: 5.2, size: 2 },
  { left: 15, delay: 1.3, dur: 4.8, size: 3 },
  { left: 23, delay: 2.1, dur: 6.0, size: 2 },
  { left: 31, delay: 0.5, dur: 5.5, size: 2 },
  { left: 42, delay: 3.2, dur: 4.5, size: 3 },
  { left: 51, delay: 1.8, dur: 5.8, size: 2 },
  { left: 58, delay: 0.9, dur: 6.2, size: 2 },
  { left: 67, delay: 2.7, dur: 4.7, size: 3 },
  { left: 74, delay: 4.1, dur: 5.3, size: 2 },
  { left: 81, delay: 1.5, dur: 5.7, size: 2 },
  { left: 89, delay: 3.6, dur: 4.9, size: 3 },
  { left: 19, delay: 4.8, dur: 5.1, size: 2 },
  { left: 35, delay: 2.4, dur: 6.3, size: 2 },
  { left: 62, delay: 0.2, dur: 4.6, size: 3 },
  { left: 93, delay: 3.9, dur: 5.4, size: 2 },
  { left: 45, delay: 5.2, dur: 5.9, size: 2 },
  { left: 76, delay: 1.1, dur: 4.4, size: 3 },
  { left: 27, delay: 4.4, dur: 6.1, size: 2 },
]
